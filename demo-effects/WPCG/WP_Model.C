  ...
  try
    {
      ...
      //mesh array is sorted from no textures to textures and the blended mesh array from textures to no textures in this way the states can 
      //flow over in each other avoiding a texture2D state change
