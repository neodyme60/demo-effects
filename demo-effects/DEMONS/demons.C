...
void draw_screen( void )
{
  ...
  draw.vDrawString(GLUT_BITMAP_HELVETICA_18, "Animation sequence of " +  current->object_name + ": " + current_demon->getAnimationCategory(), 10,  SCREEN_HEIGHT - 20);
  draw.vDrawString(GLUT_BITMAP_HELVETICA_18, "Use the mouse to select an object", 10,  SCREEN_HEIGHT - 40);
  draw.vDrawString(GLUT_BITMAP_HELVETICA_18, "Use left or right arrow to change animation of selected object", 10,  SCREEN_HEIGHT - 60);
